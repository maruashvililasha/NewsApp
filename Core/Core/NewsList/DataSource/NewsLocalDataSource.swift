...
public protocol NewsLocalDataSourceInterface {
//    func getPage(page: Int, completion: @escaping (Result<MovieListEntity?, NError>) -> Void)
//    func savePage(page: GetPopularMoviesResponce, completion: @escaping (Result<Bool, NError>) -> Void)
}

public class NewsLocalDataSource: NewsLocalDataSourceInterface {
//    
...
//    
//    public func getPage(page: Int, completion: @escaping (Result<MovieListEntity?, NError>) -> Void) {
//        do {
...
//        } catch (let error) {
//            let error = NError(errorType: .toBeShown, errorMessage: error.localizedDescription, endpoint: "CoreData \(#function)")
//            completion(.failure(error))
//        }
//    }
//    
//    private func persistPage(page: GetPopularMoviesResponce, completion: @escaping (Result<Bool, NError>) -> Void) {
...
//    }
//    
//    public func savePage(page: GetPopularMoviesResponce, completion: @escaping (Result<Bool, NError>) -> Void) {
...
//    }
//    
//    func delete(page: Int, completion: @escaping (Result<Bool,NError>) -> Void) {
